...
<link href="${pageContext.request.contextPath }/css/animate.css"
	rel='stylesheet' type='text/css' />
	<script type="text/javascript" src="${pageContext.request.contextPath }/js/hh/strate.js"></script>
...
<body>
	<!-- 获取攻略id -->
	<input type="hidden" value="${StrateO.strategy_id }" id="strate_id">
	<!-- 从session获取用户id -->
	...
	<div style="width:100%;height:410px;">
		<img src="${pageContext.request.contextPath }/upload/${StrateO.beat.beat_img }"
			style="width:100%;height:100%;z-index:2">
		<div
			style="width:200px;height:400px;margin-top: -400px;margin-left:30px;">
			<h5 style="color:#fff;writing-mode:tb-rl;writing-mode:vertical-lr;line-height: 20px">${StrateO.beat.beat_introduce }</h5>
		</div>
	</div>
	<div style="width:1200px;margin: auto;margin-top: -20px;margin-top: 5px">
		<div  style='width:1200px;border: 1px #ccc solid;'>
				<div class='' style='float: left;width: 50px;height:50px;margin: 10px'>
				<img style='width:100%;height:100%' src='/twelveTravel/upload/${StrateO.user.headimg }' alt=''></div>
				<div class='ps-review__content'>
				<input id="TimeChuo" type="hidden" value="${StrateO.strate_time }">
				<header>
				
				<p style="float: left">By&nbsp;&nbsp;<a href='javascript:void(0)'>${StrateO.user.user_name }</a>&nbsp;-&nbsp;</p><span id="StrateTime"></span> 
				</header>
				<p>${StrateO.txt }</p>
				</div>
	...
	<div id="stratecommentdiv" style="width:1200px;margin: auto;background-color:#fff">
