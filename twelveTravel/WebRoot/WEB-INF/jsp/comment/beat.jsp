  ...
  <body>
    ...
    <script type='text/javascript'>
			...
			$.ajax({
				...
				success:function(data){
					...
					$(data.obj).each(function(){
						...
						html+="<td><a href='javascript:confirm_clear("+this.beat_id+");' class='tablelink del'>删除</a></td>";
						html+="</tr> ";
					});
					//设置总条数
		...
		if(value==1){
			...
			function confirm_clear(value){
			if (confirm("确认要删除本条数据吗！")){
					URL="/twelveTravel/changedetail/delbeat?beat_id="+value;
					window.location=URL;
			return true;
			}
			return false;
